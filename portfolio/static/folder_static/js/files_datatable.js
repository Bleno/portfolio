			...
			{ "sWidth":'100px' ,"mDataProp": function(data, type, json_reg) {
                         var url_base = String(window.location.host + '/')
							...
							<ul class="dropdown-menu">\
								<li><a href="#' + data.id_doc +'"><i class="icon-pencil"></i> Editar</a></li>\
								<li><a href="excluir/' + data.id_doc +'"><i class="icon-trash"></i> Excluir</a></li>\
								<li><a href="#"><i class="icon-ban-circle"></i> Desativar</a></li>\
								<li class="divider"></li>\
								<li><a href="download/'+ data.id_doc +'"><i class="icon-download-alt"></i> Baixar</a></li>\
							</ul>\
						</div>';
                               var detalhes = "";
                               var alterar = "";
